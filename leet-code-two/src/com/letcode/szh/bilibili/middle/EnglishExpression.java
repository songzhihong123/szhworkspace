...
import com.letcode.szh.bilibili.HorseJump;

/**
 * @ClassName EnglishExpression
 * @Description EnglishExpression
 * @Author szh
 * @Date 2024年01月15日
 */
public class EnglishExpression {
    ...
    public static String num1To99(int num){
        ...
        return tyNames[high - 1] + num1To19(num % 10);
    }
    ...
    public static String num1To999(int num){
        ...
        return num1To99(high) + "hundred" + num1To99(num % 100);
