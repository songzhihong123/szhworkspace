 ...
 * @version 1.0
 */
public class ScaleLog implements Serializable{
	...
	private String logGrade = " ";		/* 日志等级*/
	private String operationObject = " ";		/* 操作对象*/
	private String operationType = " ";		/* 操作类型*/
	private String operationSource = " ";		/* 来源*/
	private String operationDesc = " ";		/* 日志内容*/
	...
	/**
	 * get the logGrade - 日志等级
	 * @return the logGrade
	 */
	@XmlAttribute(name = "logGrade")
	public String getLogGrade() {
		return logGrade;
	}
	
	/**
	 * set the logGrade - 日志等级
	 */
	...
	/**
	 * get the operationObject - 操作对象
	 * @return the operationObject
	 */
	@XmlAttribute(name = "operationObject")
	public String getOperationObject() {
		return operationObject;
	}

	/**
	 * set the operationObject - 操作对象
	 */
	...
	/**
	 * get the operationSource - 来源
	 * @return the operationSource
	 */
	@XmlAttribute(name = "operationSource")
	public String getOperationSource() {
		return operationSource;
	}

	/**
	 * set the operationSource - 来源
	 */
	...
	/**
	 * get the operationDesc - 日志内容
	 * @return the operationDesc
	 */
	@XmlAttribute(name = "operationDesc")
	public String getOperationDesc() {
		return operationDesc;
	}

	/**
	 * set the operationDesc - 日志内容
	 */
